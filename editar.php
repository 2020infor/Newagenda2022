          ...
          <div class="col-md-5">
            <div class="card card-primary">
              ...
              try{
                 ...
                 $resultSel->excecute();
                 //Mostrar os dados do BD no PHP 
                 $contar = $resultSel->rowCount();
                 if($contar>0){
                    while($show = $resultSel->FETHCH(PDO::FETCH_OBJ)){
                        $idCont = $show->idContato;
                        $nomeCont = $show->nomeContato;
                        $foneCont = $show->telefoneContato;
                        $emailCont = $show->emailContato;
                        $fotoCont = $show->fotoContato;
                    }
                 }else{
              ...
              <form action="" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInput move_uploaded_file(): UnEmail1">Endereço de E-mail</label>
          ...
          <div class="col-md-7">
            <div class="card card-primary">
              ...
              <div style="text-align:center;" class="card-body p-0">
               <img style="width-top:30px; width:200px; border-radius: 100% "src="img/contato/foto1.jpg">
               <h1>Graziela Girão</h1>
               <h2>(85)991596362</h2>
               <h3 style="margin-botom: 70px;">grazielagirao@gmail.com</h3>
              </div>
              <!-- /.card-body -->
            </div>
          </div>
